...
try {
    ...
    String statusUpdateSql = "UPDATE Overtime SET status = 'Accepted' WHERE request_id = ?";
    ...
    pst.setString(2, timeNow + " / " + dateNow);
    pst.setString(3, "Accepted Overtime");
    pst.executeUpdate();

    // Confirmation message
    JOptionPane.showMessageDialog(null, "The Request is Accepted");
